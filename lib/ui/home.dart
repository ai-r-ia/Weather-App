...
class _HomeState extends State<Home> {
  ...
  Future<void> getData() async {
    ...
    consolidatedWeatherList =
        await client.getCurrentWeather(data!.location)?.toSet().toList();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                      ...
                      child: DropdownButton(
                          ...
                          onChanged: (String? newValue) {
                            setState(() async {
                              ...
                              await client.getCurrentWeather(data!.location);
                            });
                          }),
                    )
                  ],
        ...
        //       //data obtained from API is displayed here
        //       return Column(
        //         crossAxisAlignment: CrossAxisAlignment.center,
        //         children: [
        //           currentWeather(Icons.wb_sunny_rounded, "${data!.temperature}", "${data.location}"),
        //           Sized
        //         ],
        //       )
        //     }
                ...
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      //             onTap: () {
                      //               Navigator.push(context, MaterialPageRoute(builder: (context) => DetailPage(consolidatedWeatherList: consolidatedWeatherList, selectedId: index, location: data!.location,)));
                      //             },
                      //             child: Container(
