...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    ...
    print(cities);
    for (int i = 0; i < 7; i++) {
      consolidatedWeatherList.add(consolidatedWeatherList[i] = widget
          .data); //this takes the consolidated weather for the next six days for the location searched
    }
    return Scaffold(
        appBar: AppBar(
        ...
        body: Container(
          ...
          child: Column(
            ...
            children: [
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    var futureWeatherName =
                        consolidatedWeatherList[index]['description'];
                    // var futureWeatherName = " ";
                    // if (consolidatedWeatherList[index]['temp'] > 25) {
                    //   futureWeatherName = 'clear';
                    // } else if (consolidatedWeatherList[index]['temp'] < 25 &&
                    //     consolidatedWeatherList[index]['temp'] > 18) {
                    //   futureWeatherName = 'lightrain';
                    // } else if (consolidatedWeatherList[index]['temp'] < 18 &&
                    //     consolidatedWeatherList[index]['temp'] > 10) {
                    //   futureWeatherName = 'sleet';
                    // } else if (consolidatedWeatherList[index]['temp'] < 10 &&
                    //     consolidatedWeatherList[index]['temp'] > 0) {
                    //   futureWeatherName = 'hail';
                    // } else if (consolidatedWeatherList[index]['temp'] < 0) {
                    //   futureWeatherName = 'snow';
                    // }
              ...
              // ),
              // Text(widget.data.windSpeed.toString() = widget.data.windSpeed.toString();)
            ],
          ),
        ));
  }
